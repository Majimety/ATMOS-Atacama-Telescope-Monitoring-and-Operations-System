...
Auth note:
  Authentication ทำใน main.py ก่อนเรียก telemetry_endpoint() เสมอ
  ฟังก์ชันนี้จึงไม่ต้อง (และไม่ควร) validate token ซ้ำอีกครั้ง
"""
...
async def telemetry_endpoint(ws: WebSocket):
    ...
    ฟังก์ชันนี้รับผิดชอบแค่ telemetry loop และ command dispatch
