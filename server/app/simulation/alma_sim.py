...
def _get_fallback_weather() -> WeatherData:
    ...
    # FIX: เปลี่ยนจาก absolute import เป็น relative import
    # เดิม: from weather_fetcher import ... → ModuleNotFoundError เพราะอยู่ใน package
    from .weather_fetcher import derive_pwv_from_meteo, derive_tau_from_pwv
